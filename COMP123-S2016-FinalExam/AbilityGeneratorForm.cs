...
namespace COMP123_M2020_FinalExam
{
    public partial class AbilityGeneratorForm : Form
    {
     ...
     /// </summary>
        ...
        /// <summary>
        /// When we click on swap button second ability and first ability are swapped
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// When we Choose Ability Textbox 
        /// </summary>
        ...
        /// <summary>
        /// Choosing Ability in  First combobox
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Choosing Ability in  Second combobox
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Next button Click set value of strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
